...
//import com.zerobase.everycampingbackend.domain.order.form.GetOrderDetailByCustomerForm;
...
//
//    @Override
//    public Page<OrderDetailByCustomerDto> searchByCustomer(GetOrderDetailByCustomerForm form,
//        Long customerId, Pageable pageable) {
//
//        List<OrderSpecifier> orderByList = getAllOrderSpecifiers(pageable);
//
//        List<OrderDetailByCustomerDto> list = queryFactory
//            .select(Projections.fields(OrderDetailByCustomerDto.class,
//                orders.address,
//                orders.phone,
...
//
//
//    private JPAQuery<Long> getByCustomerCount(GetOrderDetailByCustomerForm form, Long customerId) {
//        return queryFactory
