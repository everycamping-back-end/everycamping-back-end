...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> unknownException(final Exception ex){
		log.error("unknown Exception : {}, message : {} " , ErrorCode.UNKNOWN_EXCEPTION, ex.getMessage());
		return ResponseEntity.badRequest().body(new ExceptionResponse(ex.getMessage(), ErrorCode.UNKNOWN_EXCEPTION));
	}
